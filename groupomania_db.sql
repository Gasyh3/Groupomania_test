...
CREATE TABLE `comments` (
  ...
  KEY `PostId` (`PostId`),
  KEY `UserId` (`UserId`),
  CONSTRAINT `comments_ibfk_1` FOREIGN KEY (`PostId`) REFERENCES `post` (`id`),
...
CREATE TABLE `post` (
  ...
  `nbrLike` int NOT NULL DEFAULT '0',
  `nbrComment` int NOT NULL DEFAULT '0',
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  `UserId` int NOT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2022-04-06 12:55:58
